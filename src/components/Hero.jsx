    ...
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p>I can develop web Application,<br className='sm:block hidden' /> mobile application and ios application.<br className='sm:block hidden' /> I can bring your imagination<br className='sm:block hidden' /> into the world of technology<br className='sm:block hidden' />on your finger tap</p>
        </div>
      </div>
